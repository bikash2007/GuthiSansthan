      ...
      >
        <div className="flex flex-col items-center justify-center">
          ...
          {spokesperson.map((item) => (
            <div
              key={item.id}
              className="flex flex-col items-center justify-center w-full  p-6 m-4 space-y-4 transition-shadow duration-300 ease-in-out bg-white rounded-lg shadow-lg hover:shadow-xl"
            >
