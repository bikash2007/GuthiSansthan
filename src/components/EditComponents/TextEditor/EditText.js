            ...
            <div className="relative flex flex-row gap-1 w-full text-[20px]">
              ...
              <div className="flex flex-col items-center justify-center w-full overflow-hidden">
                <div className="h-[20vh] w-full p-2 text-black font-normal flex flex-col overflow-hidden rounded-md">
                  <div className="h-[40%] w-full bg-white/30 flex flex-row gap-5 items-center justify-center cursor-pointer p-2">
                    <div
                      className={`${
                ...
                <div className="flex flex-row text-white items-center justify-center w-full gap-2">
                  ...
                  <div
                    className="z-50 cursor-pointer flex items-center justify-center m-2 bg-green-600 py-1 font-normal px-2 border border-white hover:bg-green-700 text-[15px] w-fit h-fit rounded-md"
