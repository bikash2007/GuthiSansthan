        ...
        <div className="relative w-full z-50 max-h-full flex items-center justify-center h-[60px]">
          ...
          {contentHidden && (
            <>
              <>
                <label
                  className="w-[50%] h-[80%] bg-slate-600 rounded-lg flex flex-col items-center justify-center p-1 cursor-pointer"
          ...
          {image && (
            <div className="w-[50%] h-[80%]  flex items-center justify-center text-white gap-5">
              <div
