  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center w-full">
        ...
        />
        <div
          className="flex flex-col w-full lg:w-10/12 xl:w-8/12 mx-auto"
          ref={aboutRef}
        >
          <div
            id="about-us-introduction"
            className={`${sectionSelected !== "introduction" ? "hidden" : ""}`}
          >
            <Introduction />
          </div>
          <div
            id="about-us-historical-background"
            className={`${
              sectionSelected !== "historical-background" ? "hidden" : ""
            } flex justify-end`}
          >
            <HistoricalBackGround />
          </div>
          <div
            id="about-us-right-and-duties"
            className={`${
              sectionSelected !== "right-and-duties" ? "hidden" : ""
            }`}
          >
            <RightAndDuties />
          </div>
          <div
            id="about-us-organizational-structure"
            className={`${
              sectionSelected !== "organizational-structure" ? "hidden" : ""
            }`}
          >
            <OrganizationalStructure />
          </div>
          <div
            id="about-us-objectives"
            className={`${sectionSelected !== "objectives" ? "hidden" : ""}`}
          >
            <Objectives />
          </div>
        </div>
